...
public class ToolItem {
	...
	public ToolItem(Integer toolItemId, Date nextServiceDate, Tool tool, Integer toolId, Integer conditionId,
			Boolean isDeleted) {
		super();
	...
	/*public StringProperty nextServiceDateProperty() {
		return new SimpleStringProperty(new SimpleDateFormat("dd-MM-yyyy").format(nextServiceDate));
	}*/
}
