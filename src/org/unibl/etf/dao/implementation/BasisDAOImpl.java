...
public class BasisDAOImpl implements BasisDAO
{
    ...
    try
    {
      if (null == plantingDate)
      {
        ps = getConn()
              ...
              Arrays.asList(new String[]{ "planting_date" })));
      }
      else
      {
        ps = getConn()
  ...
  public List getByTakeARoot(int takeARoot) throws DAOException
  {
    ...
    try
    {
      ps = getConn()
             .prepareStatement(DBUtil.select(tableName, allColumns,
            Arrays.asList(new String[]{ "take_a_root" })));
  ...
  // helpers
  //
  protected int bindPrimaryKey(PreparedStatement ps, Basis obj, int pos)
    throws SQLException
  {
  ...
  protected int bindStdColumns(PreparedStatement ps, Basis obj, int pos)
    throws SQLException
  {
