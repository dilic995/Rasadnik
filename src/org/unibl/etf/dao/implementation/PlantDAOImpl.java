...
public class PlantDAOImpl implements PlantDAO
{
    ...
    try
    {
      if (null == scientificName)
      {
        ps = getConn()
              ...
              Arrays.asList(new String[]{ "scientific_name" })));
      }
      else
      {
        ps = getConn()
  ...
  public List getByKnownAs(String knownAs) throws DAOException
  {
    ...
    try
    {
      if (null == knownAs)
      {
        ps = getConn()
               .prepareStatement(DBUtil.selectNull(tableName, allColumns,
              Arrays.asList(new String[]{ "known_as" })));
      }
      else
      {
        ps = getConn()
  ...
  public List getByImage(Blob image) throws DAOException
  {
    ...
    try
    {
      if (null == image)
      {
        ps = getConn()
               .prepareStatement(DBUtil.selectNull(tableName, allColumns,
              Arrays.asList(new String[]{ "image" })));
      }
      else
      {
        ps = getConn()
               .prepareStatement(DBUtil.select(tableName, allColumns, Arrays.asList(new String[]{ "image" })));
  ...
  // helpers
  //
  protected int bindPrimaryKey(PreparedStatement ps, Plant obj, int pos)
    throws SQLException
  {
  ...
  protected int bindStdColumns(PreparedStatement ps, Plant obj, int pos)
    throws SQLException
  {
  ...
  protected Plant fromResultSet(ResultSet rs) throws SQLException
  {
    ...
    obj.setOwned(DBUtil.getByte(rs, "owned"));
