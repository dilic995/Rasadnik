...
public class PriceHeightRatioDAOImpl implements PriceHeightRatioDAO
{
    ...
    throws DAOException
  {
    ...
    try
    {
      ...
      DBUtil.bind(ps, pos++, id.getDateFrom());
    ...
    try
    {
      if (null == heightMin)
      {
        ps = getConn()
              ...
              Arrays.asList(new String[]{ "height_min" })));
      }
      else
      {
        ps = getConn()
  ...
  public List getByHeightMax(BigDecimal heightMax) throws DAOException
  {
    ...
    try
    {
      if (null == heightMax)
      {
        ps = getConn()
               .prepareStatement(DBUtil.selectNull(tableName, allColumns,
              Arrays.asList(new String[]{ "height_max" })));
      }
      else
      {
        ps = getConn()
  ...
  // helpers
  //
  protected int bindPrimaryKey(PreparedStatement ps, PriceHeightRatio obj, int pos)
    throws SQLException
  {
    DBUtil.bind(ps, pos++, obj.getId().getDateFrom());
    DBUtil.bind(ps, pos++, obj.getId().getPlantId());

    return pos;
  }

  protected int bindStdColumns(PreparedStatement ps, PriceHeightRatio obj, int pos)
    throws SQLException
  {
  ...
  protected PriceHeightRatio fromResultSet(ResultSet rs)
    throws SQLException
  {
    ...
    obj.setActive(DBUtil.getByte(rs, "active"));

    return obj;
  }

  protected PriceHeightRatioId getId(ResultSet rs) throws SQLException
  {
    PriceHeightRatioId obj = new PriceHeightRatioId();
