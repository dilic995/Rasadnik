...
public class PlantMaintanceActivityDAOImpl implements PlantMaintanceActivityDAO
{
    ...
    try
    {
      if (null == activity)
      {
        ps = getConn()
              ...
              Arrays.asList(new String[]{ "activity" })));
      }
      else
      {
        ps = getConn()
  ...
  // helpers
  //
  protected int bindPrimaryKey(PreparedStatement ps, PlantMaintanceActivity obj, int pos)
    throws SQLException
  {
  ...
  protected int bindStdColumns(PreparedStatement ps, PlantMaintanceActivity obj, int pos)
    throws SQLException
  {
  ...
  protected PlantMaintanceActivity fromResultSet(ResultSet rs)
    throws SQLException
  {
    ...
    obj.setPlant(DBUtil.getByte(rs, "plant"));
